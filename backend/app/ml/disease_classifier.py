...
# # from ..config import get_settings # ✅ Config se settings uthao
...
#         # Config se paths utha rahe hain
#         path1 = settings.YOLO_MODEL_V1_PATH
#         path2 = settings.YOLO_MODEL_V2_PATH
        
#         try:
#             if Path(path1).exists():
#                 self.model1 = YOLO(path1)
#                 print(f"✅ Loaded Model V1: {path1}")
#             if Path(path2).exists():
#                 self.model2 = YOLO(path2)
#                 print(f"✅ Loaded Model V2: {path2}")
#         except Exception as e:
#             print(f"❌ Error loading Dual Models: {e}")
...
#             model_path = current_dir.parent / "models" / "model_v2.pt"
